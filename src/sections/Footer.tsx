...
export default function Footer() {
  return (
    <footer dir="rtl" className="bg-[#1e1e2e] text-gray-300 pt-10 pb-6 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        {/* Brand */}
        <div>
          <h3 className="text-[#50BDE9] text-lg font-bold mb-2">
            🎓 تري سي كودينج سكول
          </h3>
        ...
        {/* Nav links */}
        <div>
          <h4 className="text-white font-semibold text-sm mb-3">◆ الرئيسية</h4>
        </div>
        ...
        {/* Contact */}
        <div>
          <h4 className="text-white font-semibold text-sm mb-3">◆ شراكاتنا</h4>
